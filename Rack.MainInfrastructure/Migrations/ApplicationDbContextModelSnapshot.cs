...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rack.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rack.Domain.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rack.Domain.Entities.OrderDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rack.Domain.Entities.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rack.Domain.Entities.Order", b =>
                {
                    b.HasOne("Rack.Domain.Entities.Account", "Accounts")
                        .WithMany()
            ...
            modelBuilder.Entity("Rack.Domain.Entities.OrderDetails", b =>
                {
                    b.HasOne("Rack.Domain.Entities.Order", null)
                        .WithMany("Details")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rack.Domain.Entities.Ticket", "Ticket")
                        .WithMany()
            ...
            modelBuilder.Entity("Rack.Domain.Entities.Ticket", b =>
                {
                    b.HasOne("Rack.Domain.Entities.Category", "Categories")
                        .WithMany()
